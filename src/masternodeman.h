...
public:
    ...
    bool GetNextMasternodeInQueueForPayment(int nBlockHeight, bool fFilterSigTime, int& nCountRet, masternode_info_t& mnInfoRet, CMasternode::SinType vSinType = CMasternode::SinType::QSTEESNODE_UNKNOWN);
